package es.icp.icp_commons.ExplosionView;
...
public class ExplosionAnimator extends ValueAnimator {
    ...
    private static final float X = UtilsExplosion.dp2Px(5);
    private static final float Y = UtilsExplosion.dp2Px(20);
    private static final float V = UtilsExplosion.dp2Px(2);
    private static final float W = UtilsExplosion.dp2Px(1);
